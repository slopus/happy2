    ...
    return (
        ...
        >
            <div class="flex items-start gap-2.5 px-3 py-2.5">
                <span
                    class="grid h-7 w-7 shrink-0 place-items-center rounded-[8px] bg-[#f3e8c9] text-[0.76rem] font-black text-[#7b5c1f]"
                    aria-hidden="true"
                >
                    ✓
                </span>
                <div class="min-w-0 flex-1">
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <span class="text-[0.57rem] font-medium text-[#9a8c72]">
                            Accepted by {props.decision.acceptedBy}
                        </span>
                    </div>
                    <h4 class="mt-1 text-[0.75rem] font-extrabold text-[#3c352a]">
                        {props.decision.title}
                    </h4>
                    <p class="mt-1 text-[0.65rem] leading-4 text-[#716758]">
                        {props.decision.summary}
                    </p>
                    <p class="mt-1.5 text-[0.56rem] font-medium text-[#998d7b]">
                        Decided by {props.decision.decidedBy}
                    </p>
                </div>
            </div>
            ...
            {expanded() && (
                <div class="border-t border-[#e8e1d4] bg-white/70 px-3 py-2.5">
                    <p class="text-[0.58rem] font-extrabold uppercase tracking-[0.07em] text-[#8a7b64]">
                        Why
                    </p>
                    <p class="mt-1 text-[0.64rem] leading-4 text-[#655c50]">
                        {props.decision.rationale}
                    </p>
                    <p class="mt-2.5 text-[0.58rem] font-extrabold uppercase tracking-[0.07em] text-[#8a7b64]">
                        Acceptance criteria
                    </p>
                    <ul class="mt-1.5 flex flex-col gap-1.5">
                        {props.decision.criteria.map((criterion) => (
                            <li class="flex items-start gap-2 text-[0.63rem] leading-4 text-[#5e564c]">
                                <span
                                    class="mt-0.5 grid h-3.5 w-3.5 shrink-0 place-items-center rounded-full bg-[#efe5ca] text-[0.5rem] font-black text-[#796027]"
                                    aria-hidden="true"
                                >
                                    ✓
                                </span>
            ...
            <div class="flex items-center justify-between border-t border-[#e8e1d4] px-3 py-2">
                ...
                <button
                    ...
                    aria-label={
                        props.attached
                            ? `${props.decision.title} decision added to context`
                            : `Add ${props.decision.title} decision to context`
                    }
