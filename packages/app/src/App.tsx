...
const initialMessages: ThreadMessage[] = [
    ...
    },
    {
        ...
        decision: {
            ...
            summary:
                "Skip the naming step, derive the initial title from the project folder, and keep rename available inline.",
            rationale:
                "This removes an early setup decision without sacrificing the distinct names teams need once multiple workspaces exist.",
            decidedBy: "Maya Chen",
            acceptedBy: 4,
            criteria: [
    ...
    },
    {
        ...
        decision: {
            ...
            summary:
                "Keep messages chronological while anchoring sparse histories directly above the pinned composer.",
            rationale:
                "Separating the scrollable timeline from the composer preserves normal message order and keeps short conversations visually connected to their input.",
            decidedBy: "Nora Kim",
            acceptedBy: 4,
            criteria: [
