import { userAccessList } from "../modules/user/userAccessList.js";
import { retentionRunStart } from "../modules/retention/retentionRunStart.js";
import { retentionRunList } from "../modules/retention/retentionRunList.js";
import { retentionRunFinish } from "../modules/retention/retentionRunFinish.js";
import { moderationReportUpdate } from "../modules/moderation/moderationReportUpdate.js";
import { moderationReportList } from "../modules/moderation/moderationReportList.js";
import { moderationReportCreate } from "../modules/moderation/moderationReportCreate.js";
import { moderationActionTake } from "../modules/moderation/moderationActionTake.js";
import { moderationActionRevoke } from "../modules/moderation/moderationActionRevoke.js";
import { dataExportUpdate } from "../modules/data-export/dataExportUpdate.js";
import { dataExportRequest } from "../modules/data-export/dataExportRequest.js";
import { dataExportList } from "../modules/data-export/dataExportList.js";
import { dataExportGet } from "../modules/data-export/dataExportGet.js";
import { dataExportCancel } from "../modules/data-export/dataExportCancel.js";
import { backupUpdate } from "../modules/backup/backupUpdate.js";
import { backupList } from "../modules/backup/backupList.js";
import { backupCreate } from "../modules/backup/backupCreate.js";
import { auditLogList } from "../modules/audit/auditLogList.js";
import { accountBanRevoke } from "../modules/moderation/accountBanRevoke.js";
import { accountBanList } from "../modules/moderation/accountBanList.js";
import { accountBanExpireDue } from "../modules/moderation/accountBanExpireDue.js";
import { accountBanApply } from "../modules/moderation/accountBanApply.js";
...
export function registerOperationsRoutes(
    ...
    app.get(
        ...
        authenticated(auth, async (request, _reply, actorUserId) => {
            ...
            const result = await auditLogList(executor, {
                actorUserId,
    ...
    app.get(
        ...
        authenticated(auth, async (request, _reply, actorUserId) => {
            ...
            const result = await accountBanList(executor, {
                actorUserId,
    ...
    app.post(
        ...
        authenticated(auth, async (request, _reply, actorUserId) => {
            ...
            return {
                ban: await accountBanRevoke(executor, {
                    actorUserId,
                    targetUserId: pathId(request, "userId"),
                    reason: optionalString(body, "reason", 2_000),
                    context: auditContext(request),
    ...
    app.post(
        ...
        authenticated(auth, async (request, _reply, actorUserId) => {
            emptyBody(request);
            return {
                expired: await accountBanExpireDue(executor, {
                    actorUserId,
                    context: auditContext(request),
                }),
            };
    ...
    app.get(
        ...
        authenticated(auth, async (request, _reply, actorUserId) => {
            ...
            const result = await moderationReportList(executor, {
                actorUserId,
    ...
    app.post(
        ...
        authenticated(auth, async (request, _reply, actorUserId) => {
            ...
            return {
                report: await moderationReportUpdate(executor, {
                    actorUserId,
    ...
    app.post(
        ...
        authenticated(auth, async (request, _reply, actorUserId) => {
            const body = requestBody(request, ["reason"]);
            return moderationActionRevoke(executor, {
                actorUserId,
    ...
    app.post(
        ...
        authenticated(auth, async (request, reply, actorUserId) => {
            ...
            const dataExport = await dataExportRequest(executor, {
                actorUserId,
                kind: "user_data",
    ...
    app.get(
        ...
        authenticated(auth, async (request, _reply, actorUserId) => {
            ...
            const result = await dataExportList(executor, {
                actorUserId,
    ...
    app.get(
        ...
        authenticated(auth, async (request, _reply, actorUserId) => {
            emptyQuery(request);
            return {
                dataExport: await dataExportGet(executor, actorUserId, pathId(request, "exportId")),
            };
        }),
    );
    app.post(
        ...
        authenticated(auth, async (request, _reply, actorUserId) => {
            emptyBody(request);
            return {
                dataExport: await dataExportCancel(executor, {
                    actorUserId,
    ...
    app.post(
        ...
        authenticated(auth, async (request, _reply, actorUserId) => {
            ...
            return {
                dataExport: await dataExportUpdate(executor, {
                    actorUserId,
                    jobId: pathId(request, "exportId"),
    ...
    app.get(
        ...
        authenticated(auth, async (request, _reply, actorUserId) => {
            const query = requestQuery(request, ["status", "before", "limit"]);
            const result = await backupList(executor, {
                actorUserId,
                status: optionalEnum(query, "status", [
                    "pending",
                    "running",
    ...
    app.post(
        ...
        authenticated(auth, async (request, _reply, actorUserId) => {
            ...
            return {
                backup: await backupUpdate(executor, {
                    actorUserId,
    ...
    app.get(
        ...
        authenticated(auth, async (request, _reply, actorUserId) => {
            ...
            const result = await retentionRunList(executor, {
                actorUserId,
    ...
    app.post(
        ...
        authenticated(auth, async (request, reply, actorUserId) => {
            ...
            const retentionRun = await retentionRunStart(executor, {
                actorUserId,
    ...
    app.post(
        ...
        authenticated(auth, async (request, _reply, actorUserId) => {
            ...
            return {
                retentionRun: await retentionRunFinish(executor, {
                    actorUserId,
    ...
    app.get(
        ...
        authenticated(auth, async (request, _reply, actorUserId) => {
            ...
            const result = await userAccessList(executor, {
                actorUserId,
                before: optionalCursor(query),
                limit: limit(query),
            });
