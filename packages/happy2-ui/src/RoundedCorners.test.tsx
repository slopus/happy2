...
it("enforces parallel nested curves and symmetric insets for every rendered happy2-ui part", async () => {
    const view = createRenderer().render(
        () => (
            <div
                data-happy2-ui="parallel-corner-outer"
                style={{
                    height: "100px",
                    position: "relative",
                    "border-radius": "14px",
            ...
            >
                <div
                    data-happy2-ui="parallel-corner-inner"
                    style={{
                        position: "absolute",
                        inset: "4px",
                        "border-radius": "10px",
    ...
    const inner = view.$('[data-happy2-ui="parallel-corner-inner"]').element as HTMLElement;
