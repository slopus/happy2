...
export function AutomationCard(props: AutomationCardProps) {
    ...
    return (
        <article
            className={["happy2-automation-card", props.className].filter(Boolean).join(" ")}
        ...
        >
            <header
                className="happy2-automation-card__header"
                data-happy2-ui="automation-card-header"
            >
                <span
                    className="happy2-automation-card__name"
                    data-happy2-ui="automation-card-name"
                >
                    {props.name}
                </span>
                <span
                    className="happy2-automation-card__switch"
            ...
            <div className="happy2-automation-card__flow" data-happy2-ui="automation-card-flow">
                <span
                    className="happy2-automation-card__trigger"
                ...
                <span
                    aria-hidden="true"
                    className="happy2-automation-card__arrow"
                    data-happy2-ui="automation-card-arrow"
                >
                    <Icon name="arrow-right" size={14} />
                </span>
                <span
                    className="happy2-automation-card__action"
            ...
            {hasDetail() ? (
                <div
                    className="happy2-automation-card__detail"
                    data-happy2-ui="automation-card-detail"
                >
                    {props.triggerLabel ? (
                        <span
                            className="happy2-automation-card__label"
                            data-happy2-ui="automation-card-trigger-label"
                        >
                            {props.triggerLabel}
                        </span>
                    ) : null}
                    {props.triggerLabel && props.actionLabel ? (
                        <span
                            aria-hidden="true"
                            className="happy2-automation-card__detail-sep"
            ...
            {props.error
                ? ((error) => (
                      <div
                          className="happy2-automation-card__error"
            ...
            {hasFooter() ? (
                <div
                    className="happy2-automation-card__footer"
                    data-happy2-ui="automation-card-footer"
                >
                    <div
                        className="happy2-automation-card__meta"
                        data-happy2-ui="automation-card-meta"
                    >
                        {props.lastRunLabel ? (
                            <span
                                className="happy2-automation-card__last"
                                data-happy2-ui="automation-card-last"
                            >
                                {props.lastRunLabel}
                            </span>
                        ) : null}
                        {props.lastRunLabel && props.nextRunLabel ? (
                            <span
                                aria-hidden="true"
                                className="happy2-automation-card__meta-sep"
                        ...
                        {props.nextRunLabel ? (
                            <span
                                className="happy2-automation-card__next"
                    ...
                    {props.onRun ? (
                        <span
                            className="happy2-automation-card__run"
