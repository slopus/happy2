...
export function AgentActivityIndicator(props: AgentActivityIndicatorProps) {
    ...
    return (
        <div
            className={["happy2-agent-activity", props.className].filter(Boolean).join(" ")}
        ...
        >
            <Avatar
                className="happy2-agent-activity__avatar"
                initials={props.initials}
                size="xs"
                tone={props.tone}
                type="agent"
            />
            <span className="happy2-agent-activity__name" data-happy2-ui="agent-activity-name">
                {props.name}
            </span>
            <span
                ...
                aria-hidden="true"
            />
            <span className="happy2-agent-activity__phase" data-happy2-ui="agent-activity-phase">
                {PHASE_LABEL[props.phase]}
            </span>
            <span className="happy2-agent-activity__meta" data-happy2-ui="agent-activity-meta">
                <span
                    className="happy2-agent-activity__tokens"
                    data-happy2-ui="agent-activity-tokens"
                >
                    {tokenLabel()}
                </span>
                <span className="happy2-agent-activity__sep" aria-hidden="true">
                    ·
                </span>
                <span
                    className="happy2-agent-activity__elapsed"
