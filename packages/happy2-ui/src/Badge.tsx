...
export function Badge(props: BadgeProps) {
    return (
        ...
        >
            {props.icon
                ? ((name) => (
                      <span className="happy2-badge__icon" data-happy2-ui="badge-icon">
                          <Icon name={name} size={12} />
                      </span>
                  ))(props.icon)
                : null}
            <span className="happy2-badge__label" data-happy2-ui="badge-label">
                {props.label}
            </span>
        </span>
    );
...
export function CountBadge(props: CountBadgeProps) {
    ...
    return (
        ...
        >
            <span className="happy2-count-badge__label" data-happy2-ui="count-badge-label">
                {props.count}
            </span>
        </span>
    );
...
export function ReactionChip(props: ReactionChipProps) {
    return (
        <button
            ...
            type="button"
        >
            <span className="happy2-reaction-chip__emoji" data-happy2-ui="reaction-chip-emoji">
                <span
            ...
            <span className="happy2-reaction-chip__count" data-happy2-ui="reaction-chip-count">
                {props.count}
            </span>
        </button>
    );
...
export function KeyCap(props: KeyCapProps) {
    return (
        ...
        >
            <span className="happy2-key-cap__label" data-happy2-ui="key-cap-label">
                {Array.from(props.keys).map((key, index) => (
                    ...
                    >
                        {shortcutSymbols.has(key) ? (
                            ...
                            <span className="happy2-key-cap__text" data-happy2-ui="key-cap-text">
                                {key}
                            </span>
                        )}
                    </span>
