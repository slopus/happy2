 ...
 * Props only, desktop only; every color and radius is a --rg-* token.
 */
export function PolicyControl(props: PolicyControlProps) {
    ...
    return (
        <div
            class={["rigged-policy-control", local.class].filter(Boolean).join(" ")}
            data-rigged-ui="policy-control"
            data-testid={props["data-testid"]}
            style={local.style}
        >
            <section
                class="rigged-policy-control__section"
                data-rigged-ui="policy-control-section"
                data-section="expiry"
            >
                <div class="rigged-policy-control__header" data-rigged-ui="policy-control-header">
                    <div class="rigged-policy-control__title" data-rigged-ui="policy-control-title">
                        Disappearing messages
                    </div>
                    <div class="rigged-policy-control__help" data-rigged-ui="policy-control-help">
                ...
                <Show when={showTimer()}>
                    <FormRow
                        class="rigged-policy-control__field rigged-policy-control__field--timer"
                        control={
                            <Select
                                onValueChange={(value) =>
                ...
                <Show when={showScope()}>
                    <FormRow
                        class="rigged-policy-control__field rigged-policy-control__field--scope"
                        control={
                            <Switch
            ...
            <Show when={showRetention()}>
                <>
                    <div
                        class="rigged-policy-control__rule"
                        data-rigged-ui="policy-control-rule"
                        role="separator"
                    />
                    <section
                        class="rigged-policy-control__section"
                    ...
                    >
                        <div
                            class="rigged-policy-control__header"
                            data-rigged-ui="policy-control-header"
                        >
                            <div
                                class="rigged-policy-control__title"
                                data-rigged-ui="policy-control-title"
                            >
                                Message retention
                            </div>
                            <div
                                class="rigged-policy-control__help"
                                data-rigged-ui="policy-control-help"
                            >
                        ...
                        <Show when={showRetentionDuration()}>
                            <FormRow
                                class="rigged-policy-control__field rigged-policy-control__field--retention"
                                control={
                                    <Select
                                        onValueChange={(value) =>
