...
it("holds FormRow layout, typography, colors, divider, and control alignment", async () => {
    ...
    const inlineText = view.$('[data-testid="inline"] [data-rigged-ui="form-row-text"]');
    ...
    const inlineControl = view.$('[data-testid="inline"] [data-rigged-ui="form-row-control"]');
    ...
    const label = view.$('[data-testid="inline"] [data-rigged-ui="form-row-label"]');
    ...
    const description = view.$('[data-testid="inline"] [data-rigged-ui="form-row-description"]');
    ...
    await assertLegibleUnclipped(view, '[data-testid="inline"] [data-rigged-ui="form-row-label"]');
    await assertLegibleUnclipped(
        view,
        '[data-testid="inline"] [data-rigged-ui="form-row-description"]',
    );
    ...
    const plainText = view.$('[data-testid="plain"] [data-rigged-ui="form-row-text"]');
    expect(plainText.height(), "label-only text height").toBe(20);
    // No description prop → no description element is rendered.
    expect(
        view.container.querySelector(
            '[data-testid="plain"] [data-rigged-ui="form-row-description"]',
        ),
        "label-only row omits description",
    ).toBeNull();
    const plainControl = view.$('[data-testid="plain"] [data-rigged-ui="form-row-control"]');
    ...
    const plainButton = '[data-testid="plain"] [data-rigged-ui="button"]';
    ...
    const stackedText = view.$('[data-testid="stacked"] [data-rigged-ui="form-row-text"]');
    const stackedControl = view.$('[data-testid="stacked"] [data-rigged-ui="form-row-control"]');
    ...
    const centerControl = view.$(
        '[data-testid="align-center"] [data-rigged-ui="form-row-control"]',
    );
    const startControl = view.$('[data-testid="align-start"] [data-rigged-ui="form-row-control"]');
    ...
    expect(
        (await view.$('[data-testid="align-center"] [data-rigged-ui="badge"]').visibleMetrics())
            .pixelCount,
        "center badge ink",
    ).toBeGreaterThan(0);
    expect(
        (await view.$('[data-testid="align-start"] [data-rigged-ui="badge"]').visibleMetrics())
            .pixelCount,
        "start badge ink",
    ).toBeGreaterThan(0);
