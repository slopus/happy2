...
it("holds DataTable geometry, alignment, selection, and header typography", async () => {
    ...
    const root = view.$('[data-rigged-ui="data-table"]');
    ...
    const table = view.$('[data-rigged-ui="data-table-table"]');
    ...
    const headRow = view.$('[data-rigged-ui="data-table-head-row"]');
    expect(headRow.bounds().height, "header row height").toBe(40);
    const nameTh = view.$('[data-rigged-ui="data-table-head"] [data-column-id="name"]');
    ...
    const nameLabel = view.$('[data-column-id="name"] [data-rigged-ui="data-table-header"]');
    const seatsLabel = view.$('[data-column-id="seats"] [data-rigged-ui="data-table-header"]');
    ...
    const nameTd = view.$('[data-rigged-ui="data-table-body"] [data-column-id="name"]');
    expect(nameTd.height(), "body cell height").toBe(48);
    const emailTd = view.$('[data-rigged-ui="data-table-body"] [data-column-id="email"]');
    expect(
    ...
    const lastRowTd = view.$(
        '[data-rigged-ui="data-table-body"] [data-row-id="alan"] [data-column-id="email"]',
    );
    ...
    const graceTd = view.$(
        '[data-rigged-ui="data-table-body"] [data-row-id="grace"] [data-column-id="email"]',
    );
    ...
    const emailCell = view.$(
        '[data-rigged-ui="data-table-body"] [data-column-id="email"] [data-rigged-ui="data-table-cell"]',
    );
    expect(Math.abs(emailCell.offsets().left - 16), "start-aligned left pad").toBeLessThanOrEqual(
        0.5,
    );
    const seatsCell = view.$(
        '[data-rigged-ui="data-table-body"] [data-column-id="seats"] [data-rigged-ui="data-table-cell"]',
    );
    ...
    const actions = view.$(
        '[data-rigged-ui="data-table-body"] [data-rigged-ui="data-table-actions"]',
    );
    ...
    const selectTd = view.$('[data-rigged-ui="data-table-body"] .rigged-data-table__td--select');
    expect(selectTd.bounds().width, "select column width").toBe(44);
    const checkBox = view.$(
        '[data-rigged-ui="data-table-select-row"] [data-rigged-ui="data-table-check-box"]',
    );
    ...
    const glyph = await inkDrift(
        view,
        '[data-rigged-ui="data-table-select-row"] [data-rigged-ui="data-table-check-box"]',
        '[data-rigged-ui="data-table-select-row"] svg',
    );
    ...
    const headerBox = view.$(
        '[data-rigged-ui="data-table-select-all"] [data-rigged-ui="data-table-check-box"]',
    );
    expect(headerBox.computedStyle("background-color"), "indeterminate fill").toBe(
        "rgb(139, 124, 247)",
    );
    const bar = view.$('[data-rigged-ui="data-table-select-all"] .rigged-data-table__check-bar');
...
it("holds DataTable dense rows, truncation, and the empty slot", async () => {
    ...
    view.render(
        () => (
            <DataTable
                ...
                empty={
                    <span style={{ color: "var(--rg-text-muted)", "font-size": "13px" }}>
    ...
    const denseHead = view.$('[data-rigged-ui="data-table-head-row"]');
    expect(denseHead.bounds().height, "dense header height").toBe(36);
    const denseTd = view.$('[data-rigged-ui="data-table-body"] [data-column-id="name"]');
    ...
    const pathCell = view.$('[data-column-id="path"] [data-rigged-ui="data-table-cell"]');
    expect(
    ...
    const empty = view.$('[data-rigged-ui="data-table-empty"]');
