...
it("holds MediaGallery grid geometry, tile anatomy, overlays, and footer typography", async () => {
    ...
    for (const id of ids) {
        const thumb = view.$(`[data-media-id="${id}"] [data-rigged-ui="media-thumb"]`);
    ...
    const thumbV = view.$('[data-media-id="v1"] [data-rigged-ui="media-thumb"]');
    const footer = view.$('[data-media-id="v1"] [data-rigged-ui="media-footer"]');
    expect(footer.bounds().y - (thumbV.bounds().y + 120), "footer top gap").toBe(8);
    expect(footer.height(), "footer height").toBe(32);

    const name = view.$('[data-media-id="v1"] [data-rigged-ui="media-name"]');
    ...
    const size = view.$('[data-media-id="v1"] [data-rigged-ui="media-size"]');
    ...
    const thumbF = view.$('[data-media-id="f1"] [data-rigged-ui="media-thumb"]');
    const glyph = view.$('[data-media-id="f1"] [data-rigged-ui="media-glyph"]');
    ...
    const icon = view.$(
        '[data-media-id="f1"] [data-rigged-ui="media-glyph"] [data-rigged-ui="icon"]',
    );
    ...
    const kind = view.$('[data-media-id="v1"] [data-rigged-ui="media-kind"]');
    ...
    const badge = view.$('[data-media-id="v1"] [data-rigged-ui="badge"]');
    expect(badge.height(), "badge height").toBe(18);
    const badgeLabel = view.$('[data-media-id="v1"] [data-rigged-ui="badge-label"]');
    ...
    const duration = view.$('[data-media-id="v1"] [data-rigged-ui="media-duration"]');
    ...
    const thumbP = view.$('[data-media-id="p1"] [data-rigged-ui="media-thumb"]');
    const image = view.$('[data-media-id="p1"] [data-rigged-ui="media-image"]');
    ...
    expect(
        view.container.querySelector('[data-media-id="p1"] [data-rigged-ui="media-kind"]'),
        "photo has no kind badge",
    ).toBeNull();
    expect(
        view.container.querySelector('[data-media-id="f1"] [data-rigged-ui="media-image"]'),
        "file has no image",
    ).toBeNull();
...
it("holds MediaGallery column density, truncation, and the empty slot", async () => {
    ...
    const thumb4 = view.$('[data-media-id="b"] [data-rigged-ui="media-thumb"]');
    ...
    const longName = view.$('[data-media-id="long"] [data-rigged-ui="media-name"]');
    ...
    const empty = view.$('[data-testid="gallery-empty"] [data-rigged-ui="media-empty"]');
    expect(empty.bounds().width, "empty spans full width").toBe(rootEmpty.bounds().width);
    expect(
        view.container.querySelector('[data-testid="gallery-empty"] [data-rigged-ui="media-tile"]'),
