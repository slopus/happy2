...
it("holds TitleBar geometry: 38px contract, grid lanes, drag chrome", async () => {
    ...
    const bar = view.$('[data-testid="crumb"]').element.closest("[data-rigged-ui='title-bar']")!;
    const root = view.$('[data-rigged-ui="title-bar"]:not([data-window-controls])');
    ...
    expect(root.textMetrics().font.family).toBe("Rigged Figtree, system-ui, sans-serif");

    const leading = view.$(
        '[data-rigged-ui="title-bar"]:not([data-window-controls]) [data-rigged-ui="title-bar-leading"]',
    );
    const trailing = view.$(
    ...
    const insetRoot = view.$('[data-rigged-ui="title-bar"][data-window-controls]');
...
it("holds SearchField geometry, colors, and optical centering", async () => {
    ...
    const field = view.$('[data-testid="fixed"] [data-rigged-ui="search-field"]');
    ...
    const icon = view.$('[data-testid="fixed"] [data-rigged-ui="search-field-icon"]');
    const iconGlyph = view.$('[data-testid="fixed"] [data-rigged-ui="search-field-icon"] svg');
    ...
    const input = view.$('[data-testid="fixed"] [data-rigged-ui="search-field-input"]');
    ...
    expect(input.textMetrics().font.family).toBe("Rigged Figtree, system-ui, sans-serif");
    ...
    const cap = view.$('[data-testid="fixed"] [data-rigged-ui="key-cap"]');
    ...
    const fluidCapControl = view.$(
        '[data-testid="cap-control-p"] [data-rigged-ui="key-cap-label"]',
    );
    ...
    const placeholderInput = view.$('[data-testid="fluid"] [data-rigged-ui="search-field-input"]');
    ...
    const pairPh = view.$('[data-testid="pair-ph"] [data-rigged-ui="search-field-input"]');
    const pairVal = view.$('[data-testid="pair-val"] [data-rigged-ui="search-field-input"]');
...
it("holds SearchField focus treatment and long-content truncation", async () => {
    ...
    const field = view.$('[data-testid="focus"] [data-rigged-ui="search-field"]');
    const input = view.$('[data-testid="focus"] [data-rigged-ui="search-field-input"]');
    ...
    const longField = view.$('[data-testid="long-value"] [data-rigged-ui="search-field"]');
    const longInput = view.$('[data-testid="long-value"] [data-rigged-ui="search-field-input"]');
    const longCap = view.$('[data-testid="long-value"] [data-rigged-ui="key-cap"]');
    ...
    const phField = view.$('[data-testid="long-ph"] [data-rigged-ui="search-field"]');
    const phInput = view.$('[data-testid="long-ph"] [data-rigged-ui="search-field-input"]');
    ...
    ).toBeLessThanOrEqual(view.$('[data-testid="long-ph"] [data-rigged-ui="key-cap"]').bounds().x);
...
it("reports SearchField input and submit through callbacks", async () => {
    ...
    const input = view.$('[data-rigged-ui="search-field-input"]').element as HTMLInputElement;
