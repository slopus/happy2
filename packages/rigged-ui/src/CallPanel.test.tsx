...
it("holds active CallPanel geometry, typography, tiles, and controls", async () => {
    ...
    const header = view.$('[data-testid="cp-panel"] [data-rigged-ui="call-panel-status"]');
    expect(header.bounds()).toEqual({ x: 33, y: 33, width: 286, height: 24 });

    const badge = view.$('[data-testid="cp-panel"] [data-rigged-ui="badge"]');
    ...
    const duration = view.$('[data-testid="cp-panel"] [data-rigged-ui="call-panel-duration"]');
    expect(duration.textMetrics().text).toBe("04:12");
    expect(duration.textMetrics().font.family).toBe("Rigged Mono, ui-monospace, monospace");
    ...
    /* ---- Tile grid ----------------------------------------------------- */
    const tiles = view.$('[data-testid="cp-panel"] [data-rigged-ui="call-panel-tiles"]');
    ...
    const wrap0 = view.$(
        '[data-testid="cp-panel"] [data-participant-id="p0"] [data-rigged-ui="call-panel-tile-avatar"]',
    );
    ...
    const avatar0 = view.$(
        '[data-testid="cp-panel"] [data-participant-id="p0"] [data-rigged-ui="avatar"]',
    );
    ...
    const ring = view.$(
        '[data-testid="cp-panel"] [data-participant-id="p0"] [data-rigged-ui="call-panel-ring"]',
    );
    ...
    expect(
        view.container.querySelector(
            '[data-testid="cp-panel"] [data-participant-id="p1"] [data-rigged-ui="call-panel-ring"]',
        ),
    ).toBeNull();

    /* Muted chip: 18px, raised, bottom-right of p1's avatar; p0 has none. */
    const mute = view.$(
        '[data-testid="cp-panel"] [data-participant-id="p1"] [data-rigged-ui="call-panel-mute"]',
    );
    const wrap1 = view.$(
        '[data-testid="cp-panel"] [data-participant-id="p1"] [data-rigged-ui="call-panel-tile-avatar"]',
    );
    ...
    expect(
        view.container.querySelector(
            '[data-testid="cp-panel"] [data-participant-id="p0"] [data-rigged-ui="call-panel-mute"]',
        ),
    ).toBeNull();

    /* Tile caption: name (13/600) + state (11/500). Joined → mint. */
    const name0 = view.$(
        '[data-testid="cp-panel"] [data-participant-id="p0"] [data-rigged-ui="call-panel-tile-name"]',
    );
    expect(name0.textMetrics().text).toBe("Ada Lovelace");
    expect(name0.textMetrics().font.family).toBe("Rigged Figtree, system-ui, sans-serif");
    ...
    const state0 = view.$(
        '[data-testid="cp-panel"] [data-participant-id="p0"] [data-rigged-ui="call-panel-tile-state"]',
    );
    ...
    /* ---- Control row --------------------------------------------------- */
    const controls = view.$('[data-testid="cp-panel"] [data-rigged-ui="call-panel-controls"]');
...
it("holds incoming card and status/kind variants", async () => {
    ...
    const callerWrap = view.$(
        '[data-testid="cp-incoming"] [data-rigged-ui="call-panel-caller-avatar"]',
    );
    ...
    const callerAvatar = view.$(
        '[data-testid="cp-incoming"] [data-rigged-ui="call-panel-caller-avatar"] [data-rigged-ui="avatar"]',
    );
    expect(callerAvatar.bounds().width).toBe(44);

    const callerName = view.$(
        '[data-testid="cp-incoming"] [data-rigged-ui="call-panel-caller-name"]',
    );
    ...
    const caller = view.$('[data-testid="cp-incoming"] [data-rigged-ui="call-panel-caller"]');
    ...
    const callerSub = view.$(
        '[data-testid="cp-incoming"] [data-rigged-ui="call-panel-caller-sub"]',
    );
    ...
    const ringingBadge = view.$('[data-testid="cp-ringing"] [data-rigged-ui="badge"]');
    ...
    expect(
        view.container.querySelector(
            '[data-testid="cp-ringing"] [data-rigged-ui="call-panel-duration"]',
        ),
    ).toBeNull();
    ...
    const ringingState = view.$(
        '[data-testid="cp-ringing"] [data-participant-id="r1"] [data-rigged-ui="call-panel-tile-state"]',
    );
    ...
    const endedBadge = view.$('[data-testid="cp-ended"] [data-rigged-ui="badge"]');
    ...
    expect(
        view.container.querySelector(
            '[data-testid="cp-ended"] [data-rigged-ui="call-panel-controls"]',
        ),
    ).toBeNull();
    const declinedState = view.$(
        '[data-testid="cp-ended"] [data-participant-id="e0"] [data-rigged-ui="call-panel-tile-state"]',
    );
    ...
    const missedState = view.$(
        '[data-testid="cp-ended"] [data-participant-id="e1"] [data-rigged-ui="call-panel-tile-state"]',
    );
