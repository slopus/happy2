...
export function FormRow(props: FormRowProps) {
    ...
    return (
        <div
            {...rest}
            class={["rigged-form-row", local.class].filter(Boolean).join(" ")}
            data-align={align()}
            data-layout={layout()}
            data-rigged-ui="form-row"
            style={local.style}
        >
            <div class="rigged-form-row__text" data-rigged-ui="form-row-text">
                <label
                    class="rigged-form-row__label"
                    data-rigged-ui="form-row-label"
                    for={local.htmlFor}
                >
                    {local.label}
                </label>
                <Show when={local.description}>
                    <span
                        class="rigged-form-row__description"
                        data-rigged-ui="form-row-description"
                    >
                        {local.description}
                    </span>
                </Show>
            </div>
            <div class="rigged-form-row__control" data-rigged-ui="form-row-control">
                {local.control}
            </div>
        </div>
    );
