...
async function valueTextDriftY(view: Renderer, id: string) {
    const control = view.$(`[data-testid="${id}"] [data-rigged-ui="select-control"]`);
    const value = view.$(`[data-testid="${id}"] [data-rigged-ui="select-value"]`);
...
it("holds Select geometry, tokens, typography, chevron centering, and value centering per size", async () => {
    ...
    for (const size of sizes) {
        ...
        const control = view.$(`[data-testid="${id}"] [data-rigged-ui="select-control"]`);
        const value = view.$(`[data-testid="${id}"] [data-rigged-ui="select-value"]`);
        const nativeSelect = view.$(`[data-testid="${id}"] [data-rigged-ui="select-native"]`);
        const chevronBox = view.$(`[data-testid="${id}"] [data-rigged-ui="select-chevron"]`);
        const chevron = view.$(`[data-testid="${id}"] [data-rigged-ui="select-chevron"] svg`);
        const label = view.$(`[data-testid="${id}"] [data-rigged-ui="select-label"]`);
...
it("holds Select placeholder, error, disabled, focus, truncation, and fullWidth states", async () => {
    ...
    const placeholderValue = view.$(
        '[data-testid="sel-placeholder"] [data-rigged-ui="select-value"]',
    );
    const placeholderSelect = view.$(
        '[data-testid="sel-placeholder"] [data-rigged-ui="select-native"]',
    );
    ...
    const errorControl = view.$('[data-testid="sel-error"] [data-rigged-ui="select-control"]');
    const errorMessage = view.$('[data-testid="sel-error"] [data-rigged-ui="select-error"]');
    expect(
    ...
    const hint = view.$('[data-testid="sel-hint"] [data-rigged-ui="select-hint"]');
    ...
    const disabledSelect = view.$('[data-testid="sel-disabled"] [data-rigged-ui="select-native"]');
    ...
    const hintControl = view.$('[data-testid="sel-hint"] [data-rigged-ui="select-control"]');
    const hintSelect = view.$('[data-testid="sel-hint"] [data-rigged-ui="select-native"]');
    ...
    const truncControl = view.$('[data-testid="sel-trunc"] [data-rigged-ui="select-control"]');
    const truncValue = view.$('[data-testid="sel-trunc"] [data-rigged-ui="select-value"]');
    const truncChevron = view.$('[data-testid="sel-trunc"] [data-rigged-ui="select-chevron"] svg');
    ...
    const fullControl = view.$('[data-testid="sel-full"] [data-rigged-ui="select-control"]');
