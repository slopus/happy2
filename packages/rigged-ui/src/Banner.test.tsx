...
it("holds Banner tone tokens, geometry, typography, and leading-icon centering", async () => {
    ...
    for (const tone of tones) {
        ...
        const slot = view.$(`[data-testid="tone-${tone}"] [data-rigged-ui="banner-icon"]`);
        ...
        const glyph = view.$(`[data-testid="tone-${tone}"] [data-rigged-ui="banner-icon"] svg`);
        ...
        const title = view.$(`[data-testid="tone-${tone}"] [data-rigged-ui="banner-title"]`);
        const message = view.$(`[data-testid="tone-${tone}"] [data-rigged-ui="banner-message"]`);
    ...
    const dismiss = view.$('[data-testid="tone-info"] [data-rigged-ui="banner-dismiss"]');
    ...
    const dismissGlyph = view.$('[data-testid="tone-info"] [data-rigged-ui="banner-dismiss"] svg');
...
it("holds Banner layout modes: message-only, no-icon, action, dismiss, and wrapping", async () => {
    ...
    const singleMsg = view.$('[data-testid="single"] [data-rigged-ui="banner-message"]');
    ...
    const singleSlot = view.$('[data-testid="single"] [data-rigged-ui="banner-icon"]');
    const singleGlyph = view.$('[data-testid="single"] [data-rigged-ui="banner-icon"] svg');
    ...
    expect(
        view.container.querySelector('[data-testid="no-icon"] [data-rigged-ui="banner-icon"]'),
    ).toBeNull();
    const noIconMsg = view.$('[data-testid="no-icon"] [data-rigged-ui="banner-message"]');
    ...
    const action = view.$('[data-testid="full"] .rigged-banner__action');
    expect(action.element.tagName).toBe("BUTTON");
    expect(action.bounds().height).toBe(28);
    expect(action.textMetrics().text).toBe("Review");
    const fullDismiss = view.$('[data-testid="full"] [data-rigged-ui="banner-dismiss"]');
    ...
    const retry = view.$('[data-testid="action-only"] .rigged-banner__action');
    ...
    expect(
        view.container.querySelector(
            '[data-testid="action-only"] [data-rigged-ui="banner-dismiss"]',
        ),
    ).toBeNull();
    ...
    const wrapMsg = view.$('[data-testid="wrap"] [data-rigged-ui="banner-message"]');
    ...
    const wrapSlot = view.$('[data-testid="wrap"] [data-rigged-ui="banner-icon"]');
    const wrapGlyph = view.$('[data-testid="wrap"] [data-rigged-ui="banner-icon"] svg');
