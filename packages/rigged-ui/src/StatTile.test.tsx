...
it("holds StatTile card geometry, typography, and trend deltas", async () => {
    ...
    const header = view.$('[data-testid="st-full"] [data-rigged-ui="stat-tile-header"]');
    const value = view.$('[data-testid="st-full"] [data-rigged-ui="stat-tile-value"]');
    const footer = view.$('[data-testid="st-full"] [data-rigged-ui="stat-tile-footer"]');
    ...
    const label = view.$('[data-testid="st-full"] [data-rigged-ui="stat-tile-label"]');
    ...
    const chip = view.$('[data-testid="st-full"] [data-rigged-ui="stat-tile-icon"]');
    ...
    const chipIcon = view.$(
        '[data-testid="st-full"] [data-rigged-ui="stat-tile-icon"] [data-rigged-ui="icon"]',
    );
    ...
    const upValue = view.$('[data-testid="st-up"] [data-rigged-ui="stat-tile-value"]');
    ...
    const delta = view.$('[data-testid="st-full"] [data-rigged-ui="stat-tile-delta"]');
    expect(delta.computedStyle("color")).toBe(trendColors.up);
    const deltaValue = view.$('[data-testid="st-full"] [data-rigged-ui="stat-tile-delta-value"]');
    ...
    const hint = view.$('[data-testid="st-full"] [data-rigged-ui="stat-tile-hint"]');
    ...
    for (const [id, trend, checkY] of [
        ...
        const arrow = view.$(`[data-testid="${id}"] [data-rigged-ui="stat-tile-delta-arrow"]`);
        ...
        const deltaEl = view.$(`[data-testid="${id}"] [data-rigged-ui="stat-tile-delta"]`);
...
it("holds StatTile tones and content states", async () => {
    ...
    for (const [id, tone] of tones.map(([id, tone]) => [id, tone] as const)) {
        const chip = view.$(`[data-testid="${id}"] [data-rigged-ui="stat-tile-icon"]`);
        ...
        const icon = view.$(
            `[data-testid="${id}"] [data-rigged-ui="stat-tile-icon"] [data-rigged-ui="icon"]`,
        );
    ...
    expect(
        view.container.querySelector('[data-testid="st-plain"] [data-rigged-ui="stat-tile-icon"]'),
        "plain has no icon",
    ).toBeNull();
    expect(
        view.container.querySelector(
            '[data-testid="st-plain"] [data-rigged-ui="stat-tile-footer"]',
        ),
        "plain has no footer",
    ).toBeNull();
    const plainValue = view.$('[data-testid="st-plain"] [data-rigged-ui="stat-tile-value"]');
    ...
    expect(
        view.container.querySelector('[data-testid="st-hint"] [data-rigged-ui="stat-tile-delta"]'),
        "hint tile has no delta",
    ).toBeNull();
    const hintFooter = view.$('[data-testid="st-hint"] [data-rigged-ui="stat-tile-footer"]');
    expect(hintFooter.offsets()).toMatchObject({ top: 93, left: 17 }); /* footer at card origin */
    const hint = view.$('[data-testid="st-hint"] [data-rigged-ui="stat-tile-hint"]');
    ...
    const longValue = view.$('[data-testid="st-long"] [data-rigged-ui="stat-tile-value"]');
