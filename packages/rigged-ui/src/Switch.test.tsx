...
async function thumbDrift(view: Renderer, testId: string) {
    const thumb = view.$(`[data-testid="${testId}"] [data-rigged-ui="switch-thumb"]`);
...
it("holds Switch track/thumb geometry, on/off colors, and thumb optical centering", async () => {
    ...
    for (const c of cases) {
        ...
        const track = view.$(`[data-testid="${c.id}"] [data-rigged-ui="switch-track"]`);
        const thumb = view.$(`[data-testid="${c.id}"] [data-rigged-ui="switch-thumb"]`);
    ...
    for (const size of ["medium", "small"] as const) {
        ...
        const offThumb = view.$(`[data-testid="${size[0]}-off"] [data-rigged-ui="switch-thumb"]`);
        const offTrack = view.$(`[data-testid="${size[0]}-off"] [data-rigged-ui="switch-track"]`);
        const onThumb = view.$(`[data-testid="${size[0]}-on"] [data-rigged-ui="switch-thumb"]`);
        const onTrack = view.$(`[data-testid="${size[0]}-on"] [data-rigged-ui="switch-track"]`);
...
it("holds Switch label typography, layout, and disabled state", async () => {
    ...
    const labMTrack = view.$('[data-testid="lab-m"] [data-rigged-ui="switch-track"]');
    const labMText = view.$('[data-testid="lab-m"] [data-rigged-ui="switch-text"]');
    const labMLabel = view.$('[data-testid="lab-m"] [data-rigged-ui="switch-label"]');
    const labMDesc = view.$('[data-testid="lab-m"] [data-rigged-ui="switch-description"]');
    ...
    const labSTrack = view.$('[data-testid="lab-s"] [data-rigged-ui="switch-track"]');
    const labSText = view.$('[data-testid="lab-s"] [data-rigged-ui="switch-text"]');
    const labSLabel = view.$('[data-testid="lab-s"] [data-rigged-ui="switch-label"]');
    const labSDesc = view.$('[data-testid="lab-s"] [data-rigged-ui="switch-description"]');
    ...
    for (const [id, checked] of [
        ...
        const track = view.$(`[data-testid="${id}"] [data-rigged-ui="switch-track"]`);
