...
it("holds DiffSnippet geometry, colors, typography, and scrolling", async () => {
    ...
    const header = view.$('[data-testid="diff-full"] [data-rigged-ui="diff-snippet-header"]');
    ...
    const file = view.$('[data-testid="diff-full"] [data-rigged-ui="diff-snippet-file"]');
    ...
    const added = view.$('[data-testid="diff-full"] [data-rigged-ui="diff-snippet-added"]');
    const removed = view.$('[data-testid="diff-full"] [data-rigged-ui="diff-snippet-removed"]');
    ...
    const stats = view.$('[data-testid="diff-full"] [data-rigged-ui="diff-snippet-stats"]');
    ...
    const number = view.$(
        '[data-testid="diff-full"] [data-kind="context"] [data-rigged-ui="diff-snippet-number"]',
    );
    ...
    const addGutter = view.$(
        '[data-testid="diff-full"] [data-kind="add"] [data-rigged-ui="diff-snippet-gutter"]',
    );
    ...
    const delGutter = view.$(
        '[data-testid="diff-full"] [data-kind="del"] [data-rigged-ui="diff-snippet-gutter"]',
    );
    expect(delGutter.element.textContent).toBe("−");
    expect(
        view.$(
            '[data-testid="diff-full"] [data-kind="context"] [data-rigged-ui="diff-snippet-gutter"]',
        ).element.textContent,
    ).toBe("");
    expect(
        view.$(
            '[data-testid="diff-full"] [data-kind="meta"] [data-rigged-ui="diff-snippet-gutter"]',
        ).element.textContent,
    ).toBe("");
    ...
    expect(plain.element.querySelector('[data-rigged-ui="diff-snippet-header"]')).toBeNull();
    expect(plain.element.querySelector('[data-rigged-ui="diff-snippet-number"]')).toBeNull();
    ...
    const plainGutter = view.$(
        '[data-testid="diff-plain"] [data-kind="add"] [data-rigged-ui="diff-snippet-gutter"]',
    );
    ...
    const scroll = view.$('[data-testid="diff-scroll"] [data-rigged-ui="diff-snippet-scroll"]');
    ...
    const code = view.$('[data-testid="diff-scroll"] [data-rigged-ui="diff-snippet-code"]');
...
it("centers DiffSnippet ink optically in all engines", { timeout: 120_000 }, async () => {
    ...
    const row = (n: number, part: string) =>
        view.$(
            `[data-testid="optical"] [data-rigged-ui="diff-snippet-line"]:nth-child(${n}) [data-rigged-ui="diff-snippet-${part}"]`,
        );
    const rowLine = (n: number) =>
        view.$(`[data-testid="optical"] [data-rigged-ui="diff-snippet-line"]:nth-child(${n})`);
    /*
    ...
    for (const [snippet, plus, minus] of [
        ...
        const added = view.$(`[data-testid="${snippet}"] [data-rigged-ui="diff-snippet-added"]`);
        const removed = view.$(
            `[data-testid="${snippet}"] [data-rigged-ui="diff-snippet-removed"]`,
        );
    ...
    for (const snippet of ["head-long", "head-digits", "head-sym"] as const) {
        const file = view.$(`[data-testid="${snippet}"] [data-rigged-ui="diff-snippet-file"]`);
