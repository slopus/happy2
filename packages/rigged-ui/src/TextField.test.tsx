...
const GAP = 8;
const FONT_FAMILY = "Rigged Figtree, system-ui, sans-serif";
...
it("holds TextField sizes, typography, label, hint, and leading-icon geometry", async () => {
    ...
    for (const size of sizes) {
        ...
        const id = `tf-${size}`;
        const control = view.$(`[data-testid="${id}"] [data-rigged-ui="text-field-control"]`);
        const input = view.$(`[data-testid="${id}"] [data-rigged-ui="text-field-input"]`);
        ...
        const label = view.$(`[data-testid="${id}"] [data-rigged-ui="text-field-label"]`);
        expect(
    ...
    const mediumInput = view.$('[data-testid="tf-medium"] [data-rigged-ui="text-field-input"]');
    ...
    const required = view.$('[data-testid="tf-small"] [data-rigged-ui="text-field-required"]');
    ...
    const hint = view.$('[data-testid="tf-small"] [data-rigged-ui="text-field-hint"]');
    ...
    const largeInput = view.$('[data-testid="tf-large"] [data-rigged-ui="text-field-input"]');
    ...
    for (const size of sizes) {
        ...
        const id = `ic-${size}`;
        const control = view.$(`[data-testid="${id}"] [data-rigged-ui="text-field-control"]`);
        const iconBox = view.$(`[data-testid="${id}"] [data-rigged-ui="text-field-icon"]`);
        const glyph = view.$(`[data-testid="${id}"] [data-rigged-ui="text-field-icon"] svg`);
        const input = view.$(`[data-testid="${id}"] [data-rigged-ui="text-field-input"]`);
        ...
        const drift = await inkDrift(
            view,
            `[data-testid="${id}"] [data-rigged-ui="text-field-icon"] svg`,
            `[data-testid="${id}"] [data-rigged-ui="text-field-icon"] svg`,
        );
    ...
    expect(
        (
            view.$('[data-testid="ic-small"] [data-rigged-ui="text-field-input"]')
...
it("holds TextField focus, error, disabled, textarea, width, and placeholder parity", async () => {
    ...
    const focusControl = view.$(
        '[data-testid="focus-field"] [data-rigged-ui="text-field-control"]',
    );
    const focusInput = view.$('[data-testid="focus-field"] [data-rigged-ui="text-field-input"]');
    ...
    const errorControl = view.$(
        '[data-testid="error-field"] [data-rigged-ui="text-field-control"]',
    );
    const errorInput = view.$('[data-testid="error-field"] [data-rigged-ui="text-field-input"]');
    const errorMsg = view.$('[data-testid="error-field"] [data-rigged-ui="text-field-error"]');
    ...
    const disabledControl = view.$(
        '[data-testid="disabled-field"] [data-rigged-ui="text-field-control"]',
    );
    const disabledInput = view.$(
        '[data-testid="disabled-field"] [data-rigged-ui="text-field-input"]',
    );
    ...
    const taControl = view.$('[data-testid="ta-field"] [data-rigged-ui="text-field-control"]');
    const taInput = view.$('[data-testid="ta-field"] [data-rigged-ui="text-field-input"]');
    ...
    expect(
        view.$('[data-testid="fw-field"] [data-rigged-ui="text-field-control"]').bounds().width,
    ).toBe(320);
    expect(view.$('[data-testid="def-field"]').bounds().width).toBe(240);

    /* ---- Placeholder vs value baseline parity --------------------------- */

    const parPh = view.$('[data-testid="par-ph"] [data-rigged-ui="text-field-input"]');
    const parVal = view.$('[data-testid="par-val"] [data-rigged-ui="text-field-input"]');
    const parValControl = view.$('[data-testid="par-val"] [data-rigged-ui="text-field-control"]');
