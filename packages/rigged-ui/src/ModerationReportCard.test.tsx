...
const q = (id: string, part?: string) =>
    part ? `[data-testid="${id}"] [data-rigged-ui="${part}"]` : `[data-testid="${id}"]`;
...
it("holds ModerationReportCard geometry, typography, status badge, parties, and actions", async () => {
    ...
    const chipIcon = view.$(
        `${q("mrc-full", "moderation-report-card-kind")} [data-rigged-ui="icon"]`,
    );
    ...
    const badge = view.$(
        `${q("mrc-full", "moderation-report-card-status")} [data-rigged-ui="badge"]`,
    );
    ...
    const reasonIcon = view.$(
        `${q("mrc-full", "moderation-report-card-reason")} [data-rigged-ui="icon"]`,
    );
    ...
    const reporterAvatar = view.$(
        `${q("mrc-full", "moderation-report-card-party")}[data-role="reporter"] [data-rigged-ui="avatar"]`,
    );
    ...
    const assigneeAvatar = view.$(
        `${q("mrc-full", "moderation-report-card-party")}[data-role="assignee"] [data-rigged-ui="avatar"]`,
    );
    ...
    const caption = view.$(
        `${q("mrc-full", "moderation-report-card-party")}[data-role="reporter"] [data-rigged-ui="moderation-report-card-party-caption"]`,
    );
    ...
    const partyName = view.$(
        `${q("mrc-full", "moderation-report-card-party")}[data-role="reporter"] [data-rigged-ui="moderation-report-card-party-name"]`,
    );
...
it("holds ModerationReportCard status variants and content states", async () => {
    ...
    for (const s of statuses) {
        ...
        const badge = view.$(`${q(`mrc-${s}`)} [data-rigged-ui="badge"]`);
    ...
    expect(
        view.container.querySelector(
            `${q("mrc-details", "moderation-report-card-party")}[data-role="assignee"] [data-rigged-ui="avatar"]`,
        ),
    ...
    const fileGlyph = await glyphDrift(
        view.$(`${q("mrc-minimal", "moderation-report-card-kind")} [data-rigged-ui="icon"]`),
        "file kind glyph",
    );
